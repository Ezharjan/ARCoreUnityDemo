...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    {
        private bool isHittedOnce = false;
        ...
        // void EnterIntoTheHouse(Touch myTouch)
        void EnterIntoTheHouse(Touch myTouch, GameObject myPrefab)
        {
            // if (isHittedOnce)
            if (instantiatedObject != null)
            {
                ...
                if (Frame.Raycast(myTouch.position.x, myTouch.position.y, raycastFilter, out hit))
                {
                    ...
                    else
                    {
                        if (isMaximized)
                        {
                            ScaleObject(myPrefab, -1);
                            isMaximized = false;
                            Debug.Log("GameObject scaled down!");
                        }
                        else
                        {
                            ScaleObject(myPrefab, 1);
                            isMaximized = true;
                            Debug.Log("GameObject scaled up!");
                        }
                    }
                }
            }
        ...
        public void Update()
        {
            ...
            Debug.Log("Will return next time!");
